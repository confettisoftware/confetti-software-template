...
const PrivacyPolicy = () => {
    return (
        <Layout>
            ...
            <p className="mb-4">
                At Confetti Software, we take your privacy seriously. Our apps, including Math Flash, SudokuPlus, and TicTacToe+, are designed to respect your
                data.
            </p>

            <h2 className="text-2xl font-semibold mt-6 mb-2">Data Collection</h2>
            <p className="mb-4">TicTacToe+ displays banner ads using Google AdMob. AdMob may collect:</p>
            ...
            <p className="mb-4">TicTacToe+ includes a one-time in-app purchase to remove ads. When ads are removed, no advertising data is collected.</p>
